...
require_once(dirname(__FILE__) . '/../vendor/tecnickcom/tcpdf/config/tcpdf_config_alt.php');

// Include the main TCPDF library (search the library on the following directories).
$tcpdf_include_dirs = array(
    realpath(dirname(__FILE__) . '/../vendor/tecnickcom/tcpdf/tcpdf.php'),// True source file
