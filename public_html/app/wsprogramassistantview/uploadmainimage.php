...
*/
  ...
  $data['success'] = false;
  try {
    $uploads_dir = '../../../private/'. $_SERVER['HTTP_HOST'].'/website/images/programassistants/';
    $meta = $_POST;
    ...
    $partialfilename = $mainobj['firstname'] . '_' . $mainobj['lastname'] . '_' . getGUID() . '.jpg';
    // $partialfilename = $mainobj['firstname'] . '_' . $mainobj['lastname'] . '.jpg';
    ...
    if ($retVal != 0) {
      $id =	$mysqli->real_escape_string($mainobj['id'] 	? (int)$mainobj['id'] : 0);
    	...
    	$query = "UPDATE cpa_ws_programassistants SET imagefilename = '$partialfilename' WHERE id = $id";
