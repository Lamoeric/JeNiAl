...
angular.module('core').directive('addContactButton', ['$uibModal', '$http', 'anycodesService', 'editContactService', 'authenticationService', 'translationService', function($uibModal, $http, anycodesService, editContactService, authenticationService, translationService) {
	return {
		restrict: 'E',
