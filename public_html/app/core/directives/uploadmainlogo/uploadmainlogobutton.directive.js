 ...
 * 
 * 	Image must be 1000px*1000px and less than 1MB
 * 
 *	inputs :
 ...
 */
angular.module('core').directive( "uploadmainlogobutton", ['$http', 'dialogService', 'authenticationService', 'translationService', 'Upload', '$timeout', function($http, dialogService, authenticationService, translationService, Upload, $timeout) {
	return {
		...
		templateUrl:'./core/directives/uploadmainlogo/uploadmainlogo.template.html',
		scope: {
			isDisabled: '=',
			callback: '&'
		},
		link: function( scope, element, attrs ) {
			translationService.getTranslation(scope, 'core/directives/uploadmainlogo', authenticationService.getCurrentLanguage());
