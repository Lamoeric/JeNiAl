...
*/
  ...
  $data['success'] = false;
  try {
    $uploads_dir = '../../../private/'. $_SERVER['HTTP_HOST'].'/website/images/news/';
    $meta = $_POST;
    ...
    $partialfilename = 'newsid'. $mainobj['id'] . '_' . getGUID() . '.jpg';
    // $partialfilename = 'newsid'. $mainobj['id'] . '.jpg';
    ...
    if ($retVal != 0) {
      $id =	$mysqli->real_escape_string($mainobj['id'] 	? (int)$mainobj['id'] : 0);
    	...
    	$query = "UPDATE cpa_ws_news SET imagefilename = '$partialfilename' WHERE id = $id";
