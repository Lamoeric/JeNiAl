...
angular.module('cpa_admin.testcsview', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/testcsview', {
    templateUrl: 'testcsview/testcsview.html',
    controller: 'testcsviewCtrl',
    resolve: {
      auth: function ($q, authenticationService) {
        ...
        if (userInfo) {
          ...
          return $q.reject({authenticated: false, newLocation: "/testcsview"});
        }
      }
    }
  });
...
.controller('testcsviewCtrl', ['$rootScope', '$scope', '$http', '$uibModal', 'anycodesService', 'dialogService', 'listsService', 'authenticationService', 'translationService', function($rootScope, $scope, $http, $uibModal, anycodesService, dialogService, listsService, authenticationService, translationService) {

	$scope.progName = "testcsView";
	...
	$scope.getAllTests = function () {
		$scope.promise = $http({
	      method: 'post',
	      url: './testcsview/manageTests.php',
  ...
  $scope.createNew = function (confirmed) {
	    ...
	    $uibModal.open({
					animation: false,
					templateUrl: 'testcsview/newtestcs.template.html',
