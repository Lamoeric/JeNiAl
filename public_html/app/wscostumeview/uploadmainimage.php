...
*/
  ...
  try {
    ...
    $uploads_dir = '../../../private/'. $_SERVER['HTTP_HOST'].'/website/images/costumes/costumeid'.$mainobj['id']."/";
    ...
    if ($retVal != 0) {
      $id =	$mysqli->real_escape_string($mainobj['id'] 	? (int)$mainobj['id'] : 0);
    	...
    	$query = "UPDATE cpa_ws_costumes SET imagefilename = '$partialfilename' WHERE id = $id";
