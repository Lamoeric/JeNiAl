...
if (!isset($testsessionsgroupsid)) {
	...
	$testSessionFreestyleTestList = $data['data'];
} else {
...
for ($z = 0; $z < count($testSessionFreestyleTestList); $z++) {
	// add a page
	$pdf->AddPage();
	...
	// set bacground image
	$img_file = K_PATH_IMAGES.'reports/tests/'.$testSessionFreestyleTestList[$z]['reportfilename'].'_'.$language.'.jpg';
...
$pdf->Output('TestSessionFreestyleTestReport.pdf', 'I');
