...
*/
  ...
  try {
    ...
    $uploads_dir =  '../../../private/'. $_SERVER['HTTP_HOST'].'/website/images/classifiedadds/addid'.$mainobj['id'].'/';
    ...
    $partialfilename = $mainobj['name'] . '_' . getGUID() . '.jpg';
    // $partialfilename = $mainobj['name'] . '.jpg';
    ...
    if ($retVal != 0) {
      $id =	$mysqli->real_escape_string($mainobj['id'] 	? (int)$mainobj['id'] : 0);
    	...
    	$query = "UPDATE cpa_ws_classifiedadds SET imagefilename = '$partialfilename' WHERE id = $id";
