...
*/
  ...
  $data['success'] = false;
  try {
    $uploads_dir = '../../../private/'. $_SERVER['HTTP_HOST'].'/website/images/sections/';
    $meta = $_POST;
    ...
    $name = $mainobj['name'];
    $partialfilename = $name . '_' . getGUID() . '.jpg';
    ...
    if ($retVal != 0) {
    	$query = "UPDATE cpa_ws_sections SET imagefilename = '$partialfilename' WHERE name = '$name'";
